...
type Querier interface {
	...
	ClaimAvailableBusSeat(ctx context.Context, id int32, status string) (bool, error)
	// buses.sql
	...
	GetSeatReservationByID(ctx context.Context, id int32) (SeatReservation, error)
	...
	UpdateBusSeatStatus(ctx context.Context, arg UpdateBusSeatStatusParams) error
	UpdateSeatReservationStatus(ctx context.Context, arg UpdateSeatReservationStatusParams) error
	UpdateSeatReservationStatusByID(ctx context.Context, arg UpdateSeatReservationStatusByIDParams) error
